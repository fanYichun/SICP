...
(define operation-table (make-table (list '*table*)))
(define get (operation-table 'lookup-proc))
(define put (operation-table 'insert-proc!))

(define operation-table-c (make-table (list '*coercion-table*)))
(define get-coercion (operation-table-c 'lookup-proc))
(define put-coercion (operation-table-c 'insert-proc!))
;;;-----------
